...
//wuzhu start
extern void AddSC_WUZHU_Integral();
extern void AddSC_WUZHU_Teleport();
extern void AddSC_WUZHU_Item();
extern void AddSC_WUZHU_DBTeleport();
//extern void AddSC_npc_acherus_taxi();
//extern void AddSC_WUZHUUlduar();
//wuzhu end
...
void AddScripts()
{
    ...
    //wuzhu start
	AddSC_WUZHU_Integral();//wuzhu
	AddSC_WUZHU_Teleport();//wuzhu
	AddSC_WUZHU_Item();//wuzhu
	AddSC_WUZHU_DBTeleport();//wuzhu
	//wuzhu end
