...
//wuzhu start
        { "sj",				SEC_PLAYER,			true,  &ChatHandler::HandleWorldCast,				   "", NULL },//wuzhu        
        { "whelp",			SEC_PLAYER,			true,  &ChatHandler::HandleWUZHUGM,					   "", NULL },//wuzhu
		{ "wq",				SEC_PLAYER,			true,  &ChatHandler::HandleWUZHUQuery,				   "", NULL },//wuzhu
        //{ "gg",			    SEC_CONSOLE,        true,  &ChatHandler::HandleGGCommand,				   "", NULL },//wuzhu
        //{ "integral",       SEC_CONSOLE,        true,  &ChatHandler::HandleIntegralCommand,			   "", NULL },//wuzhu
		//wuzhu end
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };
