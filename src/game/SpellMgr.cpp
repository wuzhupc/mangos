...
SpellSpecific GetSpellSpecific(uint32 spellId)
{
    ...
    if ((IsSpellHaveAura(spellInfo, SPELL_AURA_TRACK_CREATURES) ||
        //IsSpellHaveAura(spellInfo, SPELL_AURA_TRACK_RESOURCES)  || //wuzhu 资源跟踪可重复
...
bool IsSingleFromSpellSpecificPerTarget(SpellSpecific spellSpec1,SpellSpecific spellSpec2)
{
    switch(spellSpec1)
    {
        ...
        case SPELL_MAGE_INTELLECT:
            return spellSpec1==spellSpec2;
            //wuzhu start 修改允许多个药剂 允许多个食品 100831
		/*
        ...
        case SPELL_FOOD_AND_DRINK:
            return spellSpec2==SPELL_FOOD
                ...
                || spellSpec2==SPELL_FOOD_AND_DRINK;
				*/
			//sLog.outError("wuzhu IsSingleFromSpellSpecificPerTarget:spellSpec1-%d,spellSpec2-%d", spellSpec2,spellSpec1);
			//wuzhu end 
        default:
            return false;
    }
...
SpellCastResult SpellMgr::GetSpellAllowedInLocationError(SpellEntry const *spellInfo, uint32 map_id, uint32 zone_id, uint32 area_id, Player const* player)
{
    ...
    if (spellInfo->HasAttribute(SPELL_ATTR_EX4_CAST_ONLY_IN_OUTLAND) && !(player && player->isGameMaster()))
    {
        ...
        if(v_map!=0&&v_map!=1&&!player->isGameMaster())//wuzhu 修改飞行
