...
class ScriptMgr
{
    public:
		...
		bool OnGossipItemSelect(Player *player, Item *_Item, uint32 sender, uint32 action);//wuzhu
    ...
    private:
		...
		bool (MANGOS_IMPORT* m_pOnGossipItemSelect)(Player *player, Item *_Item, uint32 sender, uint32 action);//wuzhu
