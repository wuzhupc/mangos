...
class MANGOS_DLL_SPEC ChatHandler
{
    ...
    protected:
		...
		//wuzhu strat		
        bool HandleWorldCast(char* args);//wuzhu
		bool HandleWUZHUGM(char*args);//wuzhu
		bool HandleWUZHUQuery(char*args);//wuzhu
		//bool HandleIntegralCommand(char *playerN);//wuzhu
		//bool HandleGGCommand(char *msg);//wuzhu
		//wuzhu end
